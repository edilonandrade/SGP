...
@kill_Driver
Funcionalidade: 05.01 - Editar Personagem
...
@chrome
Cenario: 03 - Editar novo personagem
	Dado que eu navegue para a Tela Personagem
	Quando eu editar um novo personagem
	Entao eu visualizo novo personagem editado com sucesso
